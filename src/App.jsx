export default function App() {
  ...
  return (
    <div className="min-h-screen overflow-x-hidden bg-[#FFFDFE] text-slate-800">
      ...
      <header className="mx-auto max-w-7xl px-5 pt-6 sm:px-6 sm:pt-8 lg:px-8">
        <div className="flex items-center justify-between rounded-full border border-white/70 bg-white/70 px-4 py-3 shadow-[0_10px_30px_rgba(201,182,228,0.16)] backdrop-blur">
          <div className="min-w-0 flex items-center gap-3">
            <div className="flex h-11 w-11 items-center justify-center rounded-2xl bg-gradient-to-br from-[#C9B6E4] via-[#FBE7EF] to-[#D6EED0] text-xl shadow-md">
              🦉
            </div>
            <div className="min-w-0">
              <div className="text-sm font-semibold uppercase tracking-[0.18em] text-slate-500">Read with Owly</div>
              <div className="text-xs text-slate-500">Phonics • Reading • Listening • Writing</div>
            </div>
          </div>
          <a
            href="#buy"
            className="hidden rounded-full bg-[#C9B6E4] px-5 py-2.5 text-sm font-semibold text-slate-900 shadow-[0_8px_20px_rgba(201,182,228,0.35)] transition hover:-translate-y-0.5 sm:inline-flex"
          >
            Купить пособие
          </a>
        </div>
      ...
      <main>
        <section className="mx-auto max-w-7xl px-5 pb-14 pt-10 sm:px-6 sm:pt-14 lg:px-8 lg:pt-20">
          <div className="grid items-center gap-8 lg:grid-cols-[1.2fr_0.8fr] lg:gap-12">
            <div>
              ...
              <div className="mt-8 grid grid-cols-1 gap-4 sm:grid-cols-3">
                {[
                  ...
                  <div
                    key={value}
                    className="rounded-3xl border border-white/70 bg-white/80 p-5 shadow-[0_12px_30px_rgba(214,238,208,0.22)] backdrop-blur"
                  >
            ...
            <div className="relative">
              <div className="absolute -left-4 -top-4 h-24 w-24 rounded-full bg-[#F6D97A]/50 blur-2xl" />
              <div className="absolute -bottom-6 -right-3 h-28 w-28 rounded-full bg-[#C9B6E4]/40 blur-2xl" />

              <div className="relative rounded-[32px] border border-white/70 bg-white/85 p-5 shadow-[0_24px_60px_rgba(201,182,228,0.22)] backdrop-blur sm:p-6">
                <div className="rounded-[28px] border border-[#F2EAFB] bg-gradient-to-br from-[#FBF5FF] via-[#FFFDFB] to-[#F5FFF3] p-6 sm:p-7">
                  <div className="flex items-start justify-between gap-4">
                    <div>
                      <div className="text-sm font-semibold uppercase tracking-[0.22em] text-[#8D73BE]">Little readers</div>
                      <div className="mt-2 text-2xl font-black leading-tight text-slate-900">
                        Красивое и продуманное пособие для первых шагов в чтении
                      </div>
                    </div>
                    <div className="flex h-16 w-16 shrink-0 items-center justify-center rounded-3xl bg-gradient-to-br from-[#C9B6E4] to-[#FBE7EF] text-3xl shadow-md">
                      🦉
                    </div>
                  </div>
                  ...
                  <div className="mt-6 space-y-3">
                    {[
                      ...
                      <div key={item} className="flex items-center gap-3 rounded-2xl border border-white bg-white/90 px-4 py-3 shadow-sm">
                        <div
                          className={`flex h-10 w-10 items-center justify-center rounded-2xl text-lg ${
                            i % 2 === 0 ? 'bg-[#DFF0DA]' : 'bg-[#FDE8BE]'
                          }`}
                        >
                          {i === 0 ? '🔡' : i === 1 ? '📘' : i === 2 ? '🎧' : '🌟'}
                        </div>
                  ...
                  <div className="mt-6 rounded-3xl border border-[#F5DDEA] bg-[#FFF7FB] p-5">
        ...
        <section id="about" className="mx-auto max-w-7xl px-5 pb-8 sm:px-6 lg:px-8">
          <div className="grid gap-6 lg:grid-cols-[0.95fr_1.05fr]">
            <div className="rounded-[30px] border border-white/70 bg-white/85 p-6 shadow-[0_18px_40px_rgba(201,182,228,0.16)] sm:p-8">
              <div className="inline-flex rounded-full bg-[#F3ECFB] px-4 py-2 text-sm font-semibold text-[#8D73BE]">
                📌 Для кого это пособие
              </div>
              <div className="mt-6 space-y-4">
                {audience.map((item) => (
                  <div key={item} className="flex gap-3 rounded-2xl border border-[#F0E8F7] bg-[#FFFDFE] p-4">
                    <div className="mt-0.5 flex h-6 w-6 items-center justify-center rounded-full bg-[#D6EED0] text-xs">✓</div>
            ...
            <div className="rounded-[30px] border border-white/70 bg-gradient-to-br from-[#FEFCFF] to-[#FFFDF7] p-6 shadow-[0_18px_40px_rgba(246,217,122,0.15)] sm:p-8">
              <div className="inline-flex rounded-full bg-[#FFF0C8] px-4 py-2 text-sm font-semibold text-slate-700">
                ✨ Почему это пособие особенное?
              </div>
              <div className="mt-6 grid gap-4">
                {reasons.map((item, idx) => (
                  <div key={item} className="rounded-2xl border border-white bg-white/90 p-4 shadow-sm">
                    <div className="flex items-start gap-3">
                      <div className="flex h-8 w-8 items-center justify-center rounded-xl bg-[#FBE7EF] text-sm font-bold text-slate-700">
                        {idx + 1}
                      </div>
                      <p className="leading-7 text-slate-700">{item}</p>
                    </div>
        ...
        <section className="mx-auto max-w-7xl px-5 py-10 sm:px-6 sm:py-14 lg:px-8">
          <div className="mb-8 flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
            <div>
              ...
              <h2 className="mt-4 text-3xl font-black text-slate-900 sm:text-4xl">Содержание, выстроенное шаг за шагом</h2>
            </div>
          ...
          <div className="grid gap-5 md:grid-cols-2 xl:grid-cols-3">
            {features.map((item) => (
              <div
                key={item.title}
                className="group rounded-[28px] border border-white/70 bg-white/85 p-6 shadow-[0_16px_36px_rgba(201,182,228,0.12)] transition hover:-translate-y-1 hover:shadow-[0_20px_45px_rgba(201,182,228,0.18)]"
              >
                <div className="flex items-center justify-between gap-4">
                  <div className="flex h-14 w-14 items-center justify-center rounded-2xl bg-gradient-to-br from-[#C9B6E4] via-[#FBE7EF] to-[#D6EED0] text-2xl shadow-sm">
                    {item.icon}
                  </div>
                  <div className="h-2.5 w-16 overflow-hidden rounded-full bg-[#F3ECFB]">
                    <div className="h-full w-10 rounded-full bg-[#C9B6E4]" />
                  </div>
                </div>
                <h3 className="mt-5 text-xl font-bold leading-snug text-slate-900">{item.title}</h3>
                <p className="mt-3 leading-7 text-slate-600">{item.text}</p>
                <div className="mt-4 rounded-2xl border border-[#EFE6F8] bg-[#FCFAFF] p-4 text-sm font-medium text-[#7B659F]">
                  👉 {item.note}
                </div>
              </div>
            ))}
        ...
        <section className="mx-auto max-w-7xl px-5 py-4 sm:px-6 sm:py-8 lg:px-8">
          <div className="grid gap-6 lg:grid-cols-2">
            <div className="rounded-[30px] border border-white/70 bg-white/85 p-6 shadow-[0_18px_40px_rgba(201,182,228,0.14)] sm:p-8">
              <div className="inline-flex rounded-full bg-[#EAF6E6] px-4 py-2 text-sm font-semibold text-slate-700">
            ...
            <div className="rounded-[30px] border border-white/70 bg-white/85 p-6 shadow-[0_18px_40px_rgba(251,231,239,0.18)] sm:p-8">
              <div className="inline-flex rounded-full bg-[#FDECF2] px-4 py-2 text-sm font-semibold text-slate-700">
                🧩 Где можно использовать
              </div>
              <div className="mt-6 grid gap-4 sm:grid-cols-2">
                {usage.map((item, index) => (
                  <div key={item} className="rounded-2xl border border-[#F6E7EE] bg-[#FFFDFE] p-5">
                    <div className="text-2xl">{index === 0 ? '👩‍🏫' : index === 1 ? '👥' : index === 2 ? '🎓' : '🏡'}</div>
                    <div className="mt-3 font-semibold leading-7 text-slate-800">{item}</div>
                  </div>
                ))}
              </div>
            </div>
        ...
        <section id="buy" className="mx-auto max-w-7xl px-5 py-12 sm:px-6 sm:py-16 lg:px-8">
          <div className="relative overflow-hidden rounded-[36px] border border-white/70 bg-gradient-to-br from-[#C9B6E4]/28 via-white/90 to-[#FDE7B7]/45 p-6 shadow-[0_30px_70px_rgba(201,182,228,0.22)] sm:p-8 lg:p-10">
            <div className="absolute right-0 top-0 h-40 w-40 rounded-full bg-[#D6EED0]/70 blur-3xl" />
            <div className="absolute bottom-0 left-10 h-40 w-40 rounded-full bg-[#FBE7EF]/80 blur-3xl" />

            <div className="relative grid items-start gap-8 lg:grid-cols-[1fr_0.8fr]">
              <div>
                <div className="inline-flex rounded-full bg-white/85 px-4 py-2 text-sm font-semibold text-[#7B659F] shadow-sm">
                  💳 Формат и стоимость
                </div>
                <h2 className="mt-5 text-3xl font-black text-slate-900 sm:text-4xl">Пособие уже доступно!</h2>
                ...
                <div className="mt-6 rounded-[28px] border border-white bg-white/90 p-5 shadow-sm sm:p-6">
                  <div className="grid gap-4 sm:grid-cols-2">
                    <div className="rounded-2xl border border-[#EFE6F8] bg-[#FCFAFF] p-4">
                      <div className="text-sm text-slate-500">Формат</div>
                      <div className="mt-2 text-lg font-bold text-slate-900">Книга A4 • 90 стр.</div>
                    </div>
                    <div className="rounded-2xl border border-[#F7E8B5] bg-[#FFFCF3] p-4">
                      <div className="text-sm text-slate-500">Стоимость</div>
                      <div className="mt-2 text-lg font-bold text-slate-900">900 ₽ + доставка</div>
                    </div>
                    <div className="rounded-2xl border border-[#E2F1DD] bg-[#F8FFF6] p-4 sm:col-span-2">
                      <div className="text-sm text-slate-500">Дополнительно</div>
                      <div className="mt-2 text-base font-semibold text-slate-800">
                        Аудио и дополнительные материалы бесплатно доступны для скачивания по QR-коду.
                      </div>
                    </div>
                  </div>
              ...
              <div className="rounded-[30px] border border-white bg-white/90 p-6 shadow-[0_18px_40px_rgba(201,182,228,0.15)] sm:p-7">
                <div className="text-sm font-semibold uppercase tracking-[0.18em] text-[#8D73BE]">Заказ</div>
                ...
                <div className="mt-6 space-y-3">
                  {['Подходит для родителей', 'Удобно для преподавателей', 'Привлекательно для детских курсов'].map((item) => (
                    <div key={item} className="flex items-center gap-3 rounded-2xl border border-[#F0E8F7] bg-[#FFFDFE] px-4 py-3">
                      <div className="flex h-7 w-7 items-center justify-center rounded-full bg-[#D6EED0] text-sm">✓</div>
      ...
      <footer className="px-5 pb-10 pt-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-7xl">
          <div className="flex flex-col items-center justify-between gap-4 rounded-[28px] border border-white/70 bg-white/80 px-6 py-6 shadow-[0_12px_30px_rgba(201,182,228,0.12)] sm:flex-row">
            <div>
